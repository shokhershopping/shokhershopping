...
export type ViewMode = 'product' | 'stock';
...
export default function Filters<TData extends Record<string, any>>({
  ...
  const handleViewModeToggle = () => {
    if (onViewModeChange) {
      onViewModeChange(viewMode === 'product' ? 'stock' : 'product');
    }
  };
      ...
      <Flex align="center" gap="3" className="w-auto">
        ...
        {onViewModeChange && (
          ...
          >
            {viewMode === 'product' ? (
              <>
                <PiChartBar className="me-1.5 size-[18px]" strokeWidth={1.7} />
                Stock View
              </>
            ) : (
              <>
                <PiTable className="me-1.5 size-[18px]" strokeWidth={1.7} />
                Product View
              </>
            )}
          </Button>
