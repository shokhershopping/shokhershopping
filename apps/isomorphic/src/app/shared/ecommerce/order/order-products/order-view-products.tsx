...
interface OrderViewProductsProps {
  items?: CartItem[]; // Optional items prop for dynamic data
}

export default function OrderViewProducts({ items: propItems }: OrderViewProductsProps = {}) {
  const { items: cartItems } = useCart();

  // Use prop items if provided, otherwise fall back to cart items
